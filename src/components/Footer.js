        ...
        return (
            <div style={{ marginTop: 200 }}>
                <footer className="page-footer font-weight-lighter" style={{ backgroundColor: colors.primary, color: "white", fontWeight: "350" }}>
                    ...
                    <div style={{ backgroundColor: colors.secondary }} className="footer-copyright text-center py-3">© 2020 Copyright:
                        <a style={{ color: colors.white, fontWeight: "bold" }} target="_blank" href="#"> Sell & Buy Vehicle</a>
                    </div>
                </footer>
            </div>
        );
